...
if ($getPage === null || $getSite === null ||$getMaxEntries === null) {
    header("Location: ?site=1&page=users&maxEntries=20");
}
...
<nav class="navbar">
    <section class="buttons">
        ...
        <div class="middle">
            <form action="admin.php?site=<?php echo $getSite . "&page=" . $getPage . "&maxEntries=" . $getMaxEntries ?>" method="post">
...
<section id="content">
    <form method="post" action="admin.php?site=<?php echo $getSite . "&page=" . $getPage ?>">
        ...
        <div>
            ...
            <button id="apply" type="submit" name="applyMaxEntries">Apply changes</button>
